...
2. Keep your `CLERK_SECRET_KEY`, `STATIC_BLOB_READ_WRITE_TOKEN`, and `STATIC_KV_REST_API_TOKEN` entirely private on your deployment platform (e.g. Vercel dashboard).
